...
interface SshApi {
  ...
  getSettings(): Promise<{ settings: { reopenTabs: boolean; autoFtp: boolean; useSystemTitleBar: boolean }; tabs: { name: string; config: SshConnectionConfig; forkFrom?: string }[] }>
  saveSettings(data: { settings: { reopenTabs: boolean; autoFtp: boolean; useSystemTitleBar: boolean }; tabs: { name: string; config: SshConnectionConfig; forkFrom?: string }[] }): Promise<void>
